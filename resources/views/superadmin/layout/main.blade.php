...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: #9018cc">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('superadmin.costomer.index')}}">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('superadmin.category.index')}}">Categories</a>
                    <a class="collapse-item" href="{{route('superadmin.unit.index')}}">Units</a>
                    <a class="collapse-item" href="{{route('superadmin.item.index')}}">Items</a>
                </div>
            </div>
        </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Sistem Informasi Inventory 2021</span>
                </div>
            </div>
        </footer>
