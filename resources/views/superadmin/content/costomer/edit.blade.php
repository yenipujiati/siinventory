                    ...
                    <div class="card-body p-0">                        
                        <div class="col-lg-100">
                            <div class="p-4">
                                ...
                                <form action="{{route('superadmin.costomer.update', $costomer->id)}}" method="post">
                                    @csrf
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <a href="{{route('superadmin.costomer.index')}}"class ="btn btn-sm btn-danger" ><i class="fas fa-back"></i>Batal</a>
                                    </div>
